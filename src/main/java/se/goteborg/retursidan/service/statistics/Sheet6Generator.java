...
public class Sheet6Generator extends BaseSheetGenerator {
	
    public Sheet6Generator(Workbook workbook, Map<String, Object> model) {
		super(workbook, model);
	}

	
    public void createSheet() {
    	Sheet sheet = workbook.createSheet("Efterlysniningar per mån + förv");
        ...
        pageHeaderCell.setCellValue("Antal publicerade efterlysningar per förvaltning/bolag per år, per månad och totalt");
