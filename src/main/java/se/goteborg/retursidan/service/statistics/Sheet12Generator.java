...
public class Sheet12Generator extends BaseSheetGenerator {
	
    public Sheet12Generator(Workbook workbook, Map<String, Object> model) {
		super(workbook, model);
	}

	
    public void createSheet() {
    	Sheet sheet = workbook.createSheet("Bok. annons. per person, förv.b");
        ...
        pageHeaderCell.setCellValue("Antal bokade annonser per förvaltning/bolag, per person, per månad och totalt");
        ...
        for (Unit unit : allUnits) {
    		...
    		List<UserStats> fullUserList = statisticsService.getUserStatsListByUnitAndPeriodForBooker(getLifeTimeSpan(), unit);
